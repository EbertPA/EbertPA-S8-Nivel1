// To parse this data:
//
//   import { Convert, StarShipsModel } from "./file";
//
//   const starShipsModel = Convert.toStarShipsModel(json);
//
...
export class Convert {
  public static toStarShipsModel(json: string): StarShipsModel {
      return cast(JSON.parse(json), r("StarShipsModel"));
  }

  public static starShipsModelToJson(value: StarShipsModel): string {
      return JSON.stringify(uncast(value, r("StarShipsModel")), null, 2);
  }
}
